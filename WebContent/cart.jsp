    ...
    <table width="100%" border="0" align="center" class="threeboder">
        ...
        <c:forEach var="row" items="${cart}">
            <tr>
                ...
                <td align="center" class="trow">&#36<span id="price_${row.goodsid}">${row.price}</span></td>
                <td align="center" class="trow">&#36<span
        ...
        <tr>
            <td height="50" colspan="5" align="right">合計：&#36<span id="total">${total}</span>&nbsp;&nbsp;</td>
        </tr>
    </table>
    <br>
    <div align="center">
